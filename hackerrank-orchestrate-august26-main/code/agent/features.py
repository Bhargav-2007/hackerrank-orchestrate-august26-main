...
def extract_features(enriched_message: Dict[str, Any]) -> Dict[str, Any]:
    text = enriched_message.get("message_text") or enriched_message.get("text") or ""
    return {
        "text": text,
        "message_id": enriched_message.get("message_id"),
        "conversation_type": enriched_message.get("conversation_type"),
        "media_type": enriched_message.get("media_type"),
    }
